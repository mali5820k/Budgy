...
### Possible Choices for Implementation:
  ...
  - Rust, where King Cobra++ gets compiled downto Rust. This allows for utilizing Rust's existing language to implement features without having to bootstrap my own compiler for King Cobra++.
